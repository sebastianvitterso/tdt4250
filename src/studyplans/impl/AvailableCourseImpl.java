...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Available Course</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class AvailableCourseImpl extends MinimalEObjectImpl.Container implements AvailableCourse {
	/**
	...
	protected EClass eStaticClass() {
		return StudyplansPackage.Literals.AVAILABLE_COURSE;
	}
	...
	public void setMandatory(boolean newMandatory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyplansPackage.AVAILABLE_COURSE__MANDATORY, oldMandatory, mandatory));
	}
	...
	public Course getCourse() {
		if (course != null && course.eIsProxy()) {
			...
			if (course != oldCourse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StudyplansPackage.AVAILABLE_COURSE__COURSE, oldCourse, course));
			}
		}
		return course;
	}
	...
	public void setCourse(Course newCourse) {
		...
		course = newCourse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyplansPackage.AVAILABLE_COURSE__COURSE, oldCourse, course));
	}
