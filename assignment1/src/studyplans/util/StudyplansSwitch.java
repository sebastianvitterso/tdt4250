 ...
 * @generated
 */
public class StudyplansSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StudyplansPackage.AVAILABLE_COURSE: {
				AvailableCourse availableCourse = (AvailableCourse)theEObject;
				T result = caseAvailableCourse(availableCourse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StudyplansPackage.OPEN_SLOT: {
				OpenSlot openSlot = (OpenSlot)theEObject;
				T result = caseOpenSlot(openSlot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Available Course</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Available Course</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAvailableCourse(AvailableCourse object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Open Slot</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Open Slot</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpenSlot(OpenSlot object) {
		return null;
	}
